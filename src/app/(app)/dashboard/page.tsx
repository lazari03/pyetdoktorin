    ...
    >
      <div className="min-h-screen">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            {heroAppointment ? (
              <HeroCard
                ...
                onViewProfile={
                  effectiveRole === UserRole.Patient && heroAppointment.doctorId
              ...
              <HeroCard
                ...
                subtitle={
                  effectiveRole === UserRole.Doctor
	                ...
	                onJoin={effectiveRole === UserRole.Doctor ? undefined : () => nav.toNewAppointment()}
	                ctaLabel={effectiveRole === UserRole.Doctor ? undefined : (t("bookNow") || "Book now")}
	              />
            )}
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          {effectiveRole === UserRole.Doctor && earningsData ? (
            <DoctorEarningsCard
