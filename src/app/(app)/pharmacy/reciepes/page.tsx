...
export default function PharmacyReciepesPage() {
  ...
  // Shared with pharmacy/page.tsx and useNotificationsLogic, so this list is
  // fetched once per pharmacy instead of independently per consumer.
