...
import { getClinicNavDefs, getClinicProfileMenuDefs } from '@/navigation/navConfig';
...
export default function ClinicLayout({ children }: { children: React.ReactNode }) {
  ...
  const navDefs = useMemo(() => getClinicNavDefs(), []);
  const profileMenuDefs = useMemo(() => getClinicProfileMenuDefs(), []);
  ...
  return (
    <SectionShell
      ...
      activePath={pathname ?? ''}
      initials={initials}
      mobileTitleKey="clinic"
      mobileTitleFallback="Clinic"
