				...
				<div className="px-6 py-6 flex flex-col items-stretch gap-5 bg-white">
					...
					<div className="flex flex-col gap-3">
						...
						<button
							type="button"
							onClick={onClose}
							className="w-full rounded-full border border-gray-200 bg-white py-3 text-sm font-medium text-gray-700 hover:border-primary/60 hover:text-primary transition-colors"
						>
							{t('close')}
						</button>
					</div>
