...
export default function ModernCtaSection() {
  ...
  const imageSrc = "https://portokalle-storage.fra1.digitaloceanspaces.com/img/pexels-mastercowley-1199590.jpg";
    ...
    <section className="relative py-24 px-4 bg-gradient-to-br from-orange-100 via-white to-orange-200 overflow-hidden mt-16">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          <h2 className="text-5xl font-bold text-orange-600 mb-4 tracking-tight leading-tight drop-shadow-sm">{t('telemedicineAtYourFingertips')}</h2>
          <p className="text-xl text-gray-700 mb-8 max-w-xl leading-relaxed">{t('telemedicineDescription')}</p>
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-between items-center">
            <span className="text-lg font-bold text-orange-600 mr-0 sm:mr-4 mb-2 sm:mb-0">{t('joinAsPatientOrDoctor')}</span>
            <a
              href="/register"
