...
export default function DoctorHowItWorksSection() {
  ...
  <section className="bg-white p-0 mb-10 flex items-center justify-center">
      <div className="w-full max-w-4xl mx-auto flex flex-col items-center py-8 px-2">
        ...
        <a
          href="/register"
          className="mt-8 inline-block rounded-full bg-purple-600 px-8 py-4 text-base font-semibold text-white shadow hover:bg-purple-700 hover:text-white transition-colors text-center"
        >
          {t('registerNow')}
        </a>
      </div>
