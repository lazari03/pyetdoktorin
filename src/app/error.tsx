...
export default function AppError({
  ...
  useEffect(() => {
    try {
      trackAnalyticsEvent('app_error_boundary', {
    ...
    <div className="min-h-screen py-10 px-4">
      <div className="mx-auto max-w-xl bg-white rounded-3xl shadow-lg border border-purple-50 p-6 space-y-4">
        ...
        <div className="flex items-center gap-2 flex-wrap pt-1">
          <button className="btn btn-primary" onClick={reset} data-analytics="app.error.retry">
            {t('retry', 'Retry')}
          </button>
          <Link href={ROUTES.ROOT} className="btn btn-ghost" data-analytics="app.error.home">
