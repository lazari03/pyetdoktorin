      ...
      {visible.map((doc) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0 space-y-1">
            <p className="text-sm font-semibold text-gray-900 truncate">{doc.name || "Doctor"}</p>
          ...
          <button className="inline-flex items-center rounded-full border border-purple-500 px-4 py-2 text-xs font-semibold text-purple-600 hover:bg-purple-500 hover:text-white transition-colors whitespace-nowrap">
            Book again
          </button>
        </div>
      ))}
