...
const RedirectingModal: React.FC<{ show: boolean }> = ({ show }) => {
  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm ${z.loadingOverlay}`}>
      <div className={`relative w-[90%] max-w-md rounded-3xl bg-white shadow-2xl border border-purple-100 overflow-hidden ${z.modalContent}`}>
